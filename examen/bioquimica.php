...
$mpdf->writehtml(' <div style="text-align: center;"> <img src="../img/logo1.jpg"  width="50">  <h1 >Laboratorio Medico</h1></div>'.'<div style="text-align: center; font-size: 30px;">                      BIOQUIMICA                      </div>'.'<br>'.
