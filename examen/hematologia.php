...
//<img src="img/logo1.png" width="200px" alt="">


$mpdf->writehtml('<div style="text-align: center;"> <img src="../img/logo1.jpg"  width="50">  <h1 >Resultados</h1></div>'.'<div style="text-align: center; font-size: 30px;">                        HEMATOLOGIA                        </div>'.'<br>'.
"Hemoglobina ".$hemoglobina." g/dl -----------------------------------------------------------------------------  Referencia: 12-17".'<br>'.'<br>'.
"Hematocrito " .$hematocrito."%----------------------------------------------------------------------------------- Referencia: 36-50".'<br>'.'<br>'.
 ...
 '<div style=""> <img style="margin-left:20px; margin-right:300px;" src="../img/sello.jpg" width="140"> <img src="../img/firma.jpg" width="140"></div>'
