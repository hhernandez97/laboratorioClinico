...
<script>
    ...
    <body>
        ...
        <h1 class="display-4" style="padding:10px;">Datos personales</h1>
        ...
        <label>Correo electronico</label>
         ...
         <div style=" text-align: center;"> 
            ...
            <button onclick="calcular($('#nombre').val(),$('#apellido').val(),$('#fecha').val(),$('#cedula').val(),$('#correo').val(),$('#examen').val(),$('#genero').val())" class="btn btn-primary btnn" type="submit"  name="action">  Registrar
            </button>
...
<div id="resp" class="caja1">
        ...
        <h3 style="text-align: center; padding:5px">Resultados</h3>
