<?php 
  ...
  session_start();
   ...
   echo "Error al ingresar paciente, por favor verifique los datos";
  }
?>
...
&& !empty($genero)) { 
  ...
  if ($examen == 'Hematologia') {
      ...
      return'<a href="examen/hematologia.php" class="btn btn-primary"> Ver resultado </a>';
   }
   ...
   if ($examen == 'Bioquimica') {
      ...
      function bioquimica(){
         ...
         return'<a href="examen/bioquimica.php" class="btn btn-primary"> Ver resultado </a>' ;
      }
  ...
  if ($examen == "Enzimaticas") {
   function enzimaticas(){
    ...
    return '<a href="examen/enzimaticas.php" class="btn btn-primary"> Ver resultado </a>' ;
   }
...
if ($examen == 'Electrolitos') {
   function electrolitos(){
     ...
     return '<a href="examen/electrolitos.php" class="btn btn-primary"> Ver resultado </a>';
   }
